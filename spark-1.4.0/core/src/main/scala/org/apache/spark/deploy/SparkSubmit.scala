...
object SparkSubmit {
  ...
  private[deploy] def prepareSubmitEnvironment(args: SparkSubmitArguments)
    ...
    val options = List[OptionAssigner](
      ...
      // OptionAssigner(args.executorAccs, YARN, CLIENT, sysProp = "spark.executor.accs"),
      OptionAssigner(args.executorLabel, YARN, CLIENT, sysProp = "spark.executor.label"),
      ...
      // OptionAssigner(args.executorAccs, YARN, CLUSTER, clOption = "--executor-accs"),
      OptionAssigner(args.executorLabel, YARN, CLUSTER, clOption = "--executor-label"),
      ...
      // OptionAssigner(args.executorAccs, YARN, ALL_DEPLOY_MODES,
      //   sysProp = "spark.executor.accs"),
      OptionAssigner(args.executorLabel, YARN, ALL_DEPLOY_MODES,
        sysProp = "spark.executor.label"),
